...
res_lst = {
    {'MRK_SyNet-SyNet_CVT01_NetLasso_SyNet-AvgSynACr-P05000_MSN-500.mat' 'MRK_SyNet-SyNet_CVT01_NetGL_SyNet-AvgSynACr-P05000_MSN-500.mat'}
    {'MRK_CVT01_NetLasso_AvgSynACr-P10000_MSN-500.mat' 'MRK_CVT01_NetGL_AvgSynACr-P10000_MSN-500.mat'}
    {'MRK_SyNet-SyNet_CVT01_NetLasso_SyNet-AvgSynACr-P50000_MSN-500.mat' 'MRK_SyNet-SyNet_CVT01_NetGL_SyNet-AvgSynACr-P50000_MSN-500.mat'}
    {'MRK_CVT01_NetLasso_AvgSynACr-P100000_MSN-500.mat' 'MRK_CVT01_NetGL_AvgSynACr-P100000_MSN-500.mat'}
    {'MRK_SyNet-SyNet_CVT01_NetLasso_SyNet-AvgSynACr-P250000_MSN-500.mat' 'MRK_SyNet-SyNet_CVT01_NetGL_SyNet-AvgSynACr-P250000_MSN-500.mat'}
    {'MRK_SyNet-SyNet_CVT01_NetLasso_SyNet-AvgSynACr-P500000_MSN-500.mat' 'MRK_SyNet-SyNet_CVT01_NetGL_SyNet-AvgSynACr-P500000_MSN-500.mat'}
    {'MRK_SyNet-SyNet_CVT01_LExAG_None-G11748_MSN-500.mat' 'MRK_SyNet-SyNet_CVT01_LExAG_None-G11748_MSN-500.mat'}
    };
n_res = numel(res_lst);
y_lim = [0.60 0.67];
...
return
%% Saving
output_name = sprintf('./Plots/S06_PerformanceComparison_12_NetBased.pdf');

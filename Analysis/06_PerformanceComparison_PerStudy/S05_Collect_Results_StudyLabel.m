...
addpath('../_Utilities/');
res_path = './S04_Predict_StudyLabel/';
...
for si=1:n_src
	for sj=1:n_std
		res_pattern = sprintf([res_path 'Res_LassoEx_%s_%s_*.mat'], Source_lst{si}, Study_Name{sj});
...
%% Saving
save('S04_Predict_StudyLabel.mat', 'Study_Name', 'Source_lst', 'auc_cell');

% %{
%% Plotting
load('S04_Predict_StudyLabel.mat');

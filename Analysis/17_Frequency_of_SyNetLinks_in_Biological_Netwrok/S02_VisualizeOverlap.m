...
% 
net_lst = {
%     'HumanInt' 'BioPlex'  'BioGRID' 'IntAct' 'STRING' 'HBBrain' 'HBKidney' 'HBOvary' 'HBLympNode' 'HBGland' ...
    'HBEye' 'HBEpidermis' 'HBBlood' 'HBMuscle' 'HBProstate' 'HBUterus' ...
    'HBBone' 'HBColon' 'HBIntestine' 'HBHeart' 'HBLung' 'HBTestis' 'HBSpermatocyte' ...
    'HBSpermatogonium' 'HBNeuron' 'HBEpith' 'HBSpermatid' ...
    'HumanInt' 'BioPlex'  'BioGRID' 'IntAct' 'STRING' ...
    'HBNervs' 'HBKidney' 'HBLiver' 'HBRetina' 'HBStomach' 'HBBrain' 'HBOvary' 'HBLympnode' 'HBGland'
    };
n_net = numel(net_lst);
...
%         res_name = sprintf([res_path 'NetOV_%s_%s-SHFL_MP50000_SS1000.mat'], ref_lst{ri}, net_lst{ni});
...
%         set(box_h, 'LineWidth', 2);
        ...
        res_name = sprintf([res_path 'NetOV_%s_%s_MP50000_SS1000.mat'], ref_lst{ri}, net_lst{ni});
        fprintf('Reading [%s]\n', res_name);
        res_data = load(res_name, 'OL_Freq');
